...
export abstract class BaseService {
  ...
  public get<T>(id: string, body = {}): Observable<HttpEvent<T>> {
  ...
  public update<T>(id: string, body: any): Observable<HttpEvent<T>> {
    return this.http.patch<T>(`${this.baseUrl}/${id}`, body, this.httpOptions);
  }
}
